      ...
      for (const question of questions) {
        await database.query(
          `INSERT INTO questions (
             ...
             correct_option, hint, explanation, detail_a, detail_b, detail_c, detail_d, image_url
    ...
    async listByExamSet(examSetId) {
      const result = await database.query(
        `SELECT id, exam_set_id AS "examSetId", question_number AS "questionNumber", source_number AS "sourceNumber",
                ...
                detail_a AS "detailA", detail_b AS "detailB", detail_c AS "detailC", detail_d AS "detailD", image_url AS "imageUrl"
         FROM questions
         WHERE exam_set_id = $1
